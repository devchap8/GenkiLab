    ...
    return (
        <div className="flex flex-col bg-bg-main h-full w-full justify-center items-center">
            <div className="flex flex-col text-center mb-30 gap-3">
                ...
                <Link className="text-text-dim mt-10 text-2xl border py-2 px-6 rounded-lg w-fit mx-auto hover:border-genki-orange hover:bg-genki-orange hover:text-text-main transition-colors duration-250" to="/">Return Home</Link>
            </div>
        </div>
    )
}